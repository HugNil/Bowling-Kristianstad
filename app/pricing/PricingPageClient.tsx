...
export default function PricingPage() {
  ...
  return (
    <div className="bg-linear-to-b from-gray-50 to-white py-20 px-4">
      <div className="container mx-auto" aria-label="Priser">
        <section aria-label="Pris hero">
        ...
        <section aria-label="Prislistor" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {prices.map((price) => (
            <article 
              key={price.id}
